function f = allenAtlasBrowser_IL(f, templateVolume, annotationVolume, structureTree, slice_figure, save_location, save_suffix, plane)
% ------------------------------------------------
...
save("C:\Users\abourachid\Documents\GitHub\generalTools\Playground\Sacha_" + string(ud.currentSlice) + ".mat", "allData", "-v7.3");
hold(ud.atlasAx, 'on');
