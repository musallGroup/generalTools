function f = allenAtlasBrowser_SG(f, templateVolume, annotationVolume, structureTree, slice_figure, save_location, save_suffix, plane)
% ------------------------------------------------
...
save("E:\Histology\SOM exampels_" + string(ud.currentSlice) + ".mat", "allData", "-v7.3");
hold(ud.atlasAx, 'on');
