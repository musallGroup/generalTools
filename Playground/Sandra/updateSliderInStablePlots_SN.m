function updateSliderInStablePlots_SN(src, event, hText, corr_mat_plot, connections, iSeg, CC_sorted, region_per_component, line_strengths, thickness, color_list, transparency, opts)
    tic
